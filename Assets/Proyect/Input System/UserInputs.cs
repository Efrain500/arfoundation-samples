...
//     version 1.14.0
//     from Assets/Proyect/Input System/UserInputs.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Proyect/Input System/UserInputs.inputactions".
/// </summary>
/// <remarks>
...
public partial class @UserInputs: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""MobileTouch"",
            ""id"": ""135406b0-f8d0-4a16-ba51-427f6319e434"",
            ""actions"": [
                {
                    ""name"": ""Tap"",
                    ""type"": ""Button"",
                    ""id"": ""e94914da-e6fa-48f5-9cb1-b01dc2518551"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4c787395-c3a4-436c-aca8-9f66a79d5fcd"",
                ...
                {
                    ""name"": """",
                    ""id"": ""36552ae2-068c-4b8c-a7fa-447d7d431a31"",
    ...
    ~@UserInputs()
    {
        UnityEngine.Debug.Assert(!m_MobileTouch.enabled, "This will cause a leak and performance issues, UserInputs.MobileTouch.Disable() has not been called.");
    }
    ...
    public struct MobileTouchActions
    {
        ...
        /// </summary>
        public MobileTouchActions(@UserInputs wrapper) { m_Wrapper = wrapper; }
        /// <summary>
